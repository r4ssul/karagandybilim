...
function() {
  ...
  function w() {
    if (!p && document.body) {
      ...
      else if (Z && i < o && (e.offsetHeight <= i || t.offsetHeight <= i)) {
  ...
  function U(e) {
    return 1 <= e ? 1 : e <= 0 ? 0 : (1 == v.pulseNormalize && (v.pulseNormalize /= N(1)), N(e))
  }
  var Q = window.navigator.userAgent,
    ...
    Z = G && (/Version\/8/i.test(Q) || /Version\/9/i.test(Q)),
    J = (X || G || K) && !V,
    ee = !1;
  try {
  ...
  ie && J && (M(ie, e, te), M("mousedown", t), M("load", w)), oe.destroy = function() {
...
function oceanwpDropDownSearch() {
  ...
  if ("drop_down" == oceanwpLocalize.menuSearchStyle) {
    var t = $j("a.search-dropdown-toggle"),
      i = $j("#searchform-dropdown");
    t.click(function(e) {
...
function oceanwpHeaderReplaceSearch() {
  ...
  if ("header_replace" == oceanwpLocalize.menuSearchStyle)
    if ($j("#site-header").hasClass("top-header")) {
      var o = $j("#searchform-header-replace"),
        i = $j("#site-header.top-header .header-top .left"),
        n = $j("#site-header.top-header .header-top .right");
      $j("a.search-header-replace-toggle").click(function(e) {
        o.toggleClass("show"), i.toggleClass("hide"), n.toggleClass("hide");
        var t = o.css("transition-duration");
        return (t = 1e3 * t.replace("s", "")) && setTimeout(function() {
          o.find('input[type="search"]').focus()
        }, t), !1
      }), $j("#searchform-header-replace-close").click(function() {
        return o.removeClass("show"), i.removeClass("hide"), n.removeClass("hide"), !1
      }), $j(document).on("click", function(e) {
        $j(e.target).closest($j("#searchform-header-replace.show")).length || (o.removeClass("show"), i.removeClass("hide"), n.removeClass("hide"))
      })
    } else {
      o = $j("#searchform-header-replace");
      var s = $j("#site-header.header-replace #site-navigation");
      $j("a.search-header-replace-toggle").click(function(e) {
        o.toggleClass("show"), s.toggleClass("hide");
        var t = $j("#site-navigation > ul.dropdown-menu").width();
        o.css("max-width", t + 60);
        var i = o.css("transition-duration");
        return (i = 1e3 * i.replace("s", "")) && setTimeout(function() {
          o.find('input[type="search"]').focus()
        }, i), !1
      }), $j("#searchform-header-replace-close").click(function() {
        return o.removeClass("show"), s.removeClass("hide"), !1
      }), $j(document).on("click", function(e) {
        $j(e.target).closest($j("#searchform-header-replace.show")).length || (o.removeClass("show"), s.removeClass("hide"))
      })
    }
}
